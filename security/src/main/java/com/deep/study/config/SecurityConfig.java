...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	private static final String[] OPEN_PATHS = {"/",  "/user/updatePassword/**","/admin/publicApi/**","/user/publicApi/**"};
...
/*	@Bean
   ...
   /* @Bean
    public UserDetailsService userDetailsService(){
    	...
    	jdbcDaoImpl.setUsersByUsernameQuery("select name, password, 'true' as enabled from User where name=?");
    	jdbcDaoImpl.setAuthoritiesByUsernameQuery("select u.name,r.name from Role r ,User u, user_role ur where u.id=ur.user_id and r.id=ur.role_id and u.name=");
    	return jdbcDaoImpl;
    }*/
